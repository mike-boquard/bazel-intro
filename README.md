...
On macOS the pinned LLVM toolchain is intentionally not registered; the system
Xcode Clang is used instead, which builds every dependency cleanly (including gRPC).
